  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Read Dhethi's privacy policy. Learn how we collect, use, and protect your personal data, including our use of cookies and third-party advertising."
      />
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose max-w-none">
          <p>
            At Dhethi.com ("we," "our," or "us"), we are committed to protecting
          ...
          <p>
            <strong>Personal Data:</strong> When you voluntarily provide it
            through our contact form, we may collect your name, email address,
            and any other information you choose to provide in your message.
          </p>
          <p>
            <strong>Usage Data:</strong> We automatically collect certain
            information when you visit the website, including your IP address,
            browser type, operating system, referring URLs, pages viewed, and
          ...
          <p>
            ...
            AdSense, to serve ads when you visit our website. These companies
          ...
          <p>
            ...
            DoubleClick cookie enables it and its partners to serve ads to users
            based on their visit to dhethi.com and/or other sites on the
            Internet. You may opt out of the use of the DoubleClick cookie for
            interest-based advertising by visiting Google Ads Settings.
          </p>

          <h2>How We Use Your Information</h2>
          <p>
            We use the information we collect to operate and maintain our
            website, respond to your inquiries and communications, improve the
            user experience, analyze usage trends, and serve relevant
            advertisements.
          </p>
